...
<!--       <script defer src="https://use.fontawsome.com/release/v5.0.8/js/all.js"> </script>-->
    ...
    <body>
        <div >
            <nav class="navbar navbar-inverse navbar-fixed-top" style="background-color:  #00bcd4;border-color:  #1f7a1f;border:transparent;">

                <div class="container-fluid " >
                    <div class="navbar-header">
                        <a class="navbar-brand" href="javascript::void(0)" style="color: white;font-family:serifs"><span class="fa fa-mobile"></span> TrackMee</a>
                    </div>
                    <div>
            ...
            @yield('content')
            <nav class="navbar navbar-inverse navbar-fixed-bottom" style="background-color:#00bcd4 ;border-color:  #1f7a1f;border:transparent;">
