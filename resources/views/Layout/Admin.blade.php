                ...
                <div class="container-fluid" >
                    ...
                    <div style="font-family: serif">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown" >
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="font-family: seri;color: white">{{session('loggedUser')->username}}
                                    <span class="caret"></span></a>
                                <ul class="dropdown-menu">
                                    <li><a href="#"><span class="glyphicon glyphicon-user"></span> Profile</a></li>
                                    <li><a href="{{route('logout.index')}}"><span class="glyphicon glyphicon-log-out"></span> Logout</a></li>
                ...
                <div class="Main-sidebar">
                    <div class="col-md-2">
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="active">
                                <a href="{{route('admin.tracker.unlock')}}">Unlock Account</a>
                            </li>
                            <li class="active">
                                <a href="{{route('admin.tracker.show')}}">Trackers</a>
                            </li>
                            <li class="active">
                                <a href="{{route('admin.device.show')}}">Devices</a>
                            </li>
                            <li class="active">
                                <a href="#">Reports</a>
                            </li>
                            ...
                            <li class="active">
                                <a href="{{route('admin.employee.show')}}">Employees</a>
                            </li>
                            <li class="active">
